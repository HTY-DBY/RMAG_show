<template>
  <div class="q-pa-lg">
    ...
    <div class="row q-pa-sm status-row">
      ...
      <div class="status-item">网络延迟：{{ netRtt }}ms</div>
      <q-separator color="orange" vertical inset/>
...
const cpuCore = ref(navigator.hardwareConcurrency + "核");
...
const netRtt = ref(connection.rtt ?? "--");
...
// 最大触控点数、平台架构
const maxTouchPoints = ref(navigator.maxTouchPoints);
